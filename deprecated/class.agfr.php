<?php
include_once "includes/agfr-register-post-type.php"; // register post type function.
...
class AgfReport
{
    ...
    function init()
    {
        ...
        add_action('question_category_add_form_fields', array($this, 'question_category_add_form_fields'));
        ...
        add_action('add_meta_boxes', array($this, 'register_agf_list_forms_metabox'));
    ...
    public function render_data_source_metabox()
    {
        include  'metabox/views/list_forms.php';
    }


    function question_category_add_form_fields()
    {
        // call back function to add new field field
...
?>
        ...
        $selected_form_id = get_post_meta(121, 'selected_form_id', true);
        ...
        // getting all gravity forms.
        $all_form_fields = array();
        foreach ($forms as $form_lower) {
            $all_form_fields = GFAPI::get_form($form_lower->id);
        }
    ...
    {
        // function is included from agfr-register-post-type.php
        agf_register_taxonomy();
    }
    ...
    datasets: [
        ...
        options: {
            ...
            public function register_agf_list_forms_metabox()
            {
                add_meta_box(
                    'agf_list_forms', // ID
                    __('List forms', 'text_domain'), // Title
                    array($this, 'render_data_source_metabox'), // call back function that renders html for view
            ...
            public function render_label_questions_metabox($post)
            {
                ...
                $val = get_terms("question_category"); // gets the terms that are assigned to the current post.
                // log taxonomies
                $this->console_log($terms);
