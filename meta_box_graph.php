...
class meta_box_class_graph {
    ...
    public function add_reporting_metabox() {
		add_meta_box(
			...
			array( self::class, 'render_metabox' ), // call back function that renders html for view
...
add_action( 'add_meta_boxes', array( 'meta_box_class_graph', 'add_reporting_metabox'  ));
// Called when user clicks publish or save page.
add_action( 'save_post',      array( 'meta_box_class_graph', 'save_reporting_metabox' ), 10, 2 );
