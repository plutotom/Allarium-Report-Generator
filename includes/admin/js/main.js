  ...
  if (category_data) {
    Object.values(category_data).forEach((category, index, array) => {
      ...
      load_category_html += `<div id="${category.category_id}" class="col-12 col-md-8 container category-container">
        <input onChange="agf_prepare_category_data(event, jQuery);" name="category-title[]" type="text" id="${category.category_id}" class="category-title"  placeholder="Category Name" value="${category.category_title}"/>
  ...
  $(document).ready(function () {
    ...
    $("#add-question-category").on("click", function (event) {
      ...
      var category_html = `<div id="${category_uid}" class="col-12 col-md-8 container category-container">
          <input onChange="agf_prepare_category_data(event, jQuery);" name="category-title[]" type="text" id="${category_uid}" class="category-title"  placeholder="Category Name"/>
