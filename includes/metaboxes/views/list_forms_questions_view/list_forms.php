<!-- This file list all gravity forms that are active. A user can select a form to 
    start making a schema with its questions -->
<div id="agf-multi-select-forms-div">

    <strong> <label for="agf-multi-select-forms"><?php esc_html_e('What forms would you like to make this schema for?', 'agf'); ?></label></strong>
    ...
    ?><select size='8' name="agf-multi-select-forms[]" id="agf-multi-select-forms" multiple><?php
            ...
            <?php
                                                                                                        ...
                                                                                                        Agf_Helper_Class::console_log("running?"); ?>
